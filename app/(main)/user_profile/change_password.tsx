...
export default function ChangePasswordScreen() {
    ...
    switch (errorCode) {
      ...
      case "EMAIL_NOT_CONFIRMED":
        return {
          ...
          message: "Please verify your email address before changing your password.",
        }
      case "RATE_LIMITED":
        return {
      ...
      case "PASSWORD_TOO_WEAK":
        return {
          ...
          message: "Your new password doesn't meet the security requirements.",
        }
      ...
      case "VERIFICATION_FAILED":
        return {
          ...
          message: "Unable to verify your current password. Please try again.",
        }
      case "UPDATE_FAILED":
        return {
          title: "Update Failed",
  ...
  const handleChangePassword = async () => {
    // Input validation with specific notifications
    if (!currentPassword.trim()) {
      showWarning("Missing Information", "Please enter your current password.")
      return
    }

    if (currentPassword.length < 6) {
      showWarning("Invalid Input", "Current password seems too short. Please check your input.")
      return
    }

    if (!isPasswordValid) {
      showError("Invalid Password", "Please ensure your new password meets all security requirements.")
      return
    }

    if (!passwordsMatch) {
      showError("Password Mismatch", "New passwords do not match. Please check both fields.")
      return
    }

    if (currentPassword === newPassword) {
      showWarning("Same Password", "Your new password must be different from your current password.")
      return
    }
      ...
      >
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Update your password for {userEmail}</Text>
          </View>
